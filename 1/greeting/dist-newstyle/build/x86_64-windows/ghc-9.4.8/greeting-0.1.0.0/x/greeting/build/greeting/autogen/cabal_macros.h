...
/* package greeting-0.1.0.0 */
#ifndef VERSION_greeting
#define VERSION_greeting "0.1.0.0"
#endif /* VERSION_greeting */
#ifndef MIN_VERSION_greeting
#define MIN_VERSION_greeting(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_greeting */
...
#define CURRENT_COMPONENT_ID "greeting-0.1.0.0-inplace-greeting"
